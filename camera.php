    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top" id="navbar-design" style="background-color: #393e46;">
        ...
        <div class="collapse navbar-collapse" id="div_menu">
            ...
            <ul class="navbar-nav" id="user">
                <li>
                    <div class="form-inline active my-2 my-lg-0">
                        <a class="nav-link active font_nav" href="#">
                ...
                <li class="ml-lg-3 d-none d-lg-block">
                    <a class="nav-link font_nav form-inline mb-2 mb-lg-0" href="profil.php">
                ...
                <li class="ml-auto ml-lg-2">
                    <div class="form-inline mr-sm-1 mb-lg-0">
                        <a class="nav-link mr-3 mr-lg-1 font_nav" href="../action/logout.php">
    ...
    <div class="container">
        <div class="row">
            <div class="left rounded-left  col-lg-5 col-md-12 col-ms-12 col-xs-12">
                ...
                <div class="row">
                    <button id="btn-clear-image" type="button" class="btn btn-secondary col-3 mr-auto mt-4 ml-auto"
                        onclick="clear_img()">clear image</button>
                    <button id="btn-save-image" type="button" class="btn btn-secondary col-3 mr-auto mt-4"
                        onclick="image_sent()" disabled>Save Image</button>
                    <button id="btn-get-emoji" type="button" class="btn btn-secondary col-3 mr-auto mt-4"
                        onclick="get_div_emoji()" disabled>Get Emoji</button>
                </div>
            </div>
            <div class="right col-lg-7 col-md-12 col-ms-12 col-xs-12 rounded-right">
                ...
                <div id="DivCameraCapture">
                    <div class="row">
                        <div class="borderDashed col-8 mt-3 ml-auto mr-auto"
                            style="padding-left: 2px;padding-right: 2px;border-radius: 5px;height: 317px;">
                            <video id="stream" style="border-radius: 8px;"></video>
                        </div>
                    </div>
                    <div class="row">
                        <button id="btn-capture" type="button" class="btn btn-info col-4 mt-3 ml-auto mr-auto"
                            onclick="captureSnapshot()" disabled>Capture Image</button>
                    </div>
                </div>
                <div id="DivUploadImageCapture">
                    <div class="row">
                        <div class="borderDashed col-8 mt-3 ml-auto mr-auto"
                            style="padding-left: 2px;padding-right: 2px;border-radius: 5px;height: 317px;display: flex;">
                            <p style="margin: auto;">Click or drag and drop to upload image</p>
                            <input type="file" id="inputUploadImage" onchange="createPostUploadFile()"
                                onclick="resetInput()" accept="image/*">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="divChooseEmoji" class="fullScreenDiv">
            <div class="divEmoji container">
                ...
                <button type="button" class="btn btn-primary" style="margin-bottom: 10px;"
                    onclick="document.getElementById('divChooseEmoji').style.display='none'">Close</button>
            </div>
        </div>
    </div>
