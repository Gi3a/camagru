...
<body>
    <div class="container">
        <div class="row align-items-center mt-5 flex-column">
            <form method="POST" class="col-lg-5 col-xs-12"
                action="../action/create_password.php?token=<?php echo $_GET['token']; ?>">
                ...
                <div class="row">
                    <input type="password" class="form-control col-12" id="new_password" placeholder="* * * * * * * *"
                        name="new_password">
                </div>
                <div class="row mt-4">
                ...
                <div class="row">
                    <input type="password" class="form-control col-12" id="confirmer_new_password"
                        placeholder="* * * * * * * *" name="confirmer_new_password">
                </div>
                <div class="row mt-5">
                ...
                <div class="row mt-4">
                    ...
                    <div class="alert alert-danger col-12" id="error-password-format">
                        Error! "password format not valid must be 8-16 characters and uppercase and lowercase letter and
