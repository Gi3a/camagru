...
<body>
            ...
            <ul class="navbar-nav" id="gest">
                <li>
                    <div class="form-inline mb-2 mb-lg-0">
                        <a class="nav-link font_nav" href="create_sing_up.php">
                ...
                <li class="ml-lg-3">
                    <div class="form-inline active mb-2 mb-lg-0">
                        <a class="nav-link active font_nav" href="login.php">
                ...
                <form action="login.php" method="POST">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 mt-12">
                            ...
                            <input class="form-control" type="text" placeholder="User Name" id="user-input"
                    ...
                    <p onclick="document.getElementById('sendMail').style.display='block'" id="forgot"
                        class="d-flex justify-content-end">Forgot
                        password?</p>
                    <input type="submit" class="btn btn-info col-lg-12" name="sumbit" id="submit" value="Log In"
                        required>
                </form>
            </div>
        </div>
    ...
    <div id="sendMail">
        <img class="closeFormSendMail" src="/img/close.png"
            onclick="document.getElementById('sendMail').style.display='none'" />
        <form class="container container-post col-lg-3 col-md-8 col-xs-12 " action="/action/send_email.php"
            method="post">
            <input type="hidden" name="token" value="<?= $_SESSION['token_login'] ?>">
            <div class="input-group  mt-3 col-lg-12 col-md-12 col-ms-12 col-xs-12">
                <input class="form-control" type="email" placeholder="Enter your email" id="flog-input"
            ...
            <div class="row">
                <input type="submit"
                    class="btn btn-info col-lg-5 col-md-8 col-ms-8 col-xs-8 mt-3 mr-auto ml-auto d-block"" name=" Send"
                    id="send" value="Send">
            </div>
        </form>
    </div>
    ...
    if (isset($_SESSION['info-send']))
        echo '<script type="text/javascript"> sendEmailState(' . $_SESSION['info-send'] . ');</script>';
    $_SESSION['info-send'] = "";
